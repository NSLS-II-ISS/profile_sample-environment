...
ghs_ch1_reactor = EpicsSignal('XF:08IDB-UT{Gas:1-Vlv:VSV0101}Cmd', name='ghs_ch1_reactor')
ghs_ch2_reactor = EpicsSignal('XF:08IDB-UT{Gas:1-Vlv:VSV0201}Cmd', name='ghs_ch2_reactor')

ghs_ch1_exhaust = EpicsSignal('XF:08IDB-UT{Gas:1-Vlv:PSV0101}Cmd', name='ghs_ch1_reactor')
ghs_ch2_exhaust = EpicsSignal('XF:08IDB-UT{Gas:1-Vlv:PSV0201}Cmd', name='ghs_ch2_reactor')
